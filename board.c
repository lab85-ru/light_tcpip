...
USART_TypeDef* const COM_USART[COMn] = {H_COM1, H_COM2, H_COM3};//, H_COM4, H_COM5};

GPIO_TypeDef* const COM_TX_PORT[COMn] = {H_COM1_TX_GPIO_PORT, H_COM2_TX_GPIO_PORT, H_COM3_TX_GPIO_PORT};//, H_COM4_TX_GPIO_PORT, H_COM5_TX_GPIO_PORT};
GPIO_TypeDef* const COM_RX_PORT[COMn] = {H_COM1_RX_GPIO_PORT, H_COM2_RX_GPIO_PORT, H_COM3_RX_GPIO_PORT};//, H_COM4_RX_GPIO_PORT, H_COM5_RX_GPIO_PORT};
const uint32_t COM_USART_CLK[COMn] = {H_COM1_CLK, H_COM2_CLK, H_COM3_CLK};//, H_COM4_CLK, H_COM5_CLK};
const uint32_t COM_TX_PORT_CLK[COMn] = {H_COM1_TX_GPIO_CLK, H_COM2_TX_GPIO_CLK, H_COM3_TX_GPIO_CLK};//, H_COM4_TX_GPIO_CLK, H_COM5_TX_GPIO_CLK};
const uint32_t COM_RX_PORT_CLK[COMn] = {H_COM1_RX_GPIO_CLK, H_COM2_RX_GPIO_CLK, H_COM3_RX_GPIO_CLK};//, H_COM4_RX_GPIO_CLK, H_COM5_RX_GPIO_CLK};
const uint16_t COM_TX_PIN[COMn] = {H_COM1_TX_PIN, H_COM2_TX_PIN, H_COM3_TX_PIN};//, H_COM4_TX_PIN, H_COM5_TX_PIN};
const uint16_t COM_RX_PIN[COMn] = {H_COM1_RX_PIN, H_COM2_RX_PIN, H_COM3_RX_PIN};//, H_COM4_RX_PIN, H_COM5_RX_PIN};
...
//		if (DEBUG) printf_d("stm32_uart_set Enable speed=%d \r\n",USART_InitStruct->USART_BaudRate);
...
//	if (DEBUG) printf_d("stm32_uart_set Disable speed=%d \r\n",USART_InitStruct->USART_BaudRate);
	portDISABLE_INTERRUPTS();
